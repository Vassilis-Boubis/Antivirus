...
var chart_1_y = [ 400, 564, 345, 360, 450, 480, 375, 505, 307, 506, 630, 415,
		270, 478 ];
var chart_2_y = [ 1500, 1165, 1265, 740, 1455, 1534, 1254, 1650, 1560, 1864,
		1455, 1427, 1524, 1630 ];
...
$(window).on('load', function() {
	...
	drawCircle('#chart-4', 2, 100, '#circle-2');
